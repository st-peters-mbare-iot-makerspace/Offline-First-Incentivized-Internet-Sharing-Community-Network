...
public class SubscriptionsActivity extends AppCompatActivity {
    ...
    private static SubscriptionsActivity instance; // Way of accessing the application context from other classes
    ...
    public void requestHypeRequiredPermissions(Activity activity) {
        ...
        // SubscriptionsActivity.onRequestPermissionsResult()
        ...
        subscribeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                displayServicesNamesList("Subscribe",
                        ...
                        uiData.getUnsubscribedServicesAdapter(SubscriptionsActivity.this),
        ...
        unsubscribeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                displayServicesNamesList("Unsubscribe",
                        ...
                        uiData.getSubscribedServicesAdapter(SubscriptionsActivity.this),
        ...
        publishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                displayServicesNamesList("Publish",
                        ...
                        uiData.getAvailableServicesAdapter(SubscriptionsActivity.this),
    ...
    private void setListenerCheckOwnIdButton() {
        checkOwnIdButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                AlertDialogUtils.showInfoDialog(SubscriptionsActivity.this, "Own Device",
    ...
    private void displayServicesNamesList(String title,
        ...
        final ListView listView = new ListView(SubscriptionsActivity.this);
        listView.setAdapter(serviceNamesAdapter);

        LinearLayout layout = new LinearLayout(SubscriptionsActivity.this);
    ...
    private class subscribeServiceAction implements IServiceAction {
        ...
        public void action(String userInput) {
            ...
            if (hps.ownSubscriptions.containsSubscriptionWithServiceName(serviceName)) {
                AlertDialogUtils.showInfoDialog(SubscriptionsActivity.this,
            ...
            if (wasSubscribed) {
                uiData.addSubscribedService(SubscriptionsActivity.this, serviceName);
                uiData.removeUnsubscribedService(SubscriptionsActivity.this, serviceName);
            }
        }
    }
    ...
    private class unsubscribeServiceAction implements IServiceAction {
        ...
        public void action(String userInput) {
            ...
            if (wasUnsubscribed) {
                uiData.addUnsubscribedService(SubscriptionsActivity.this, serviceName);
                uiData.removeSubscribedService(SubscriptionsActivity.this, serviceName);
            }
        }
    }
    ...
    private void processNewServiceSelection(final IServiceAction serviceAction) {
        AlertDialogUtils.ISingleInputDialog newServiceInput = new AlertDialogUtils.ISingleInputDialog() {
            ...
            public void onOk(String input) {
                ...
                uiData.addAvailableService(SubscriptionsActivity.this, serviceName);
                uiData.addUnsubscribedService(SubscriptionsActivity.this, serviceName);
